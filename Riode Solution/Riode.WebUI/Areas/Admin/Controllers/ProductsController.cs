...
namespace Riode.WebUI.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,SKUCode,BrandId,CategoryId,ShortDescription,Description,Id,CreatedByUserId,CreatedDate,DeleteByUserId,DeleteDate")] Products products)
        {
